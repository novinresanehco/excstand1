...
<?php $component->withAttributes([]); ?>
     <?php $__env->slot('header', null, []); ?> 
        <h2 class="font-semibold text-xl text-gray-800 dark:text-gray-200 leading-tight">
            <?php echo e(__("Upload Excel File")); ?>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.text-input','data' => ['id' => 'excel_file','class' => 'block mt-1 w-full','type' => 'file','name' => 'excel_file','required' => true,'autofocus' => true,'accept' => '.xlsx,.xls']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
...
<?php $attributes = $attributes->except(collect($constructor->getParameters())->map->getName()->all()); ?>
<?php endif; ?>
<?php $component->withAttributes(['id' => 'excel_file','class' => 'block mt-1 w-full','type' => 'file','name' => 'excel_file','required' => true,'autofocus' => true,'accept' => '.xlsx,.xls']); ?>
...
<?php endif; ?>
                            ...
                            <p class="mt-1 text-sm text-gray-600 dark:text-gray-400">
                                <?php echo e(__("Max file size: 5MB.")); ?>
                        ...
                        <div class="mb-4">
                            ...
                            <select name="output_format" id="output_format" class="block mt-1 w-full border-gray-300 dark:border-gray-700 dark:bg-gray-900 dark:text-gray-300 focus:border-indigo-500 dark:focus:border-indigo-600 focus:ring-indigo-500 dark:focus:ring-indigo-600 rounded-md shadow-sm" required>
                                <option value="html" <?php echo e(old("output_format", "html") == "html" ? "selected" : ""); ?>>HTML</option>
                                <option value="sql" <?php echo e(old("output_format") == "sql" ? "selected" : ""); ?>>SQL</option>
                            </select>
...
<?php endif; ?>
<?php $component->withAttributes([]); ?>
                                <?php echo e(__("Upload and Convert")); ?>
...
<?php endif; ?><?php /**PATH C:\xampp\htdocs\ExcelStandardizer\excel-standardizer\resources\views/upload/create.blade.php ENDPATH**/ ?>